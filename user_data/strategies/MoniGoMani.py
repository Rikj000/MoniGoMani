...
class MoniGoMani(IStrategy):
    ...
    buy_params = {
        ...
        '_downwards_trend_total_buy_signal_needed': 65,
        '_sideways_trend_total_buy_signal_needed': 65,
        '_upwards_trend_total_buy_signal_needed': 65,

        # Downwards Trend Buy Signal Weight Influence Table
        'downwards_trend_adx_strong_up_buy_weight': 20,
        'downwards_trend_bollinger_bands_buy_weight': 20,
        'downwards_trend_ema_long_golden_cross_buy_weight': 20,
        'downwards_trend_ema_short_golden_cross_buy_weight': 20,
        'downwards_trend_macd_buy_weight': 20,
        'downwards_trend_rsi_buy_weight': 20,
        'downwards_trend_sma_long_golden_cross_buy_weight': 20,
        'downwards_trend_sma_short_golden_cross_buy_weight': 20,
        'downwards_trend_vwap_cross_buy_weight': 20,

        # Sideways Trend Buy Signal Weight Influence Table
        'sideways_trend_adx_strong_up_buy_weight': 20,
        'sideways_trend_bollinger_bands_buy_weight': 20,
        'sideways_trend_ema_long_golden_cross_buy_weight': 20,
        'sideways_trend_ema_short_golden_cross_buy_weight': 20,
        'sideways_trend_macd_buy_weight': 20,
        'sideways_trend_rsi_buy_weight': 20,
        'sideways_trend_sma_long_golden_cross_buy_weight': 20,
        'sideways_trend_sma_short_golden_cross_buy_weight': 20,
        'sideways_trend_vwap_cross_buy_weight': 20,

        # Upwards Trend Buy Signal Weight Influence Table
        'upwards_trend_adx_strong_up_buy_weight': 20,
        'upwards_trend_bollinger_bands_buy_weight': 20,
        'upwards_trend_ema_long_golden_cross_buy_weight': 20,
        'upwards_trend_ema_short_golden_cross_buy_weight': 20,
        'upwards_trend_macd_buy_weight': 20,
        'upwards_trend_rsi_buy_weight': 20,
        'upwards_trend_sma_long_golden_cross_buy_weight': 20,
        'upwards_trend_sma_short_golden_cross_buy_weight': 20,
        'upwards_trend_vwap_cross_buy_weight': 20
    }
    ...
    sell_params = {
        ...
        '_downwards_trend_total_sell_signal_needed': 65,
        '_sideways_trend_total_sell_signal_needed': 65,
        '_upwards_trend_total_sell_signal_needed': 65,

        # Downwards Trend Sell Signal Weight Influence Table
        'downwards_trend_adx_strong_down_sell_weight': 20,
        'downwards_trend_bollinger_bands_sell_weight': 20,
        'downwards_trend_ema_long_death_cross_sell_weight': 20,
        'downwards_trend_ema_short_death_cross_sell_weight': 20,
        'downwards_trend_macd_sell_weight': 20,
        'downwards_trend_rsi_sell_weight': 20,
        'downwards_trend_sma_long_death_cross_sell_weight': 20,
        'downwards_trend_sma_short_death_cross_sell_weight': 100,
        'downwards_trend_vwap_cross_sell_weight': 20,

        # Sideways Trend Sell Signal Weight Influence Table
        'sideways_trend_adx_strong_down_sell_weight': 20,
        'sideways_trend_bollinger_bands_sell_weight': 20,
        'sideways_trend_ema_long_death_cross_sell_weight': 20,
        'sideways_trend_ema_short_death_cross_sell_weight': 20,
        'sideways_trend_macd_sell_weight': 20,
        'sideways_trend_rsi_sell_weight': 20,
        'sideways_trend_sma_long_death_cross_sell_weight': 100,
        'sideways_trend_sma_short_death_cross_sell_weight': 20,
        'sideways_trend_vwap_cross_sell_weight': 20,

        # Upwards Trend Sell Signal Weight Influence Table
        'upwards_trend_adx_strong_down_sell_weight': 20,
        'upwards_trend_bollinger_bands_sell_weight': 20,
        'upwards_trend_ema_long_death_cross_sell_weight': 20,
        'upwards_trend_ema_short_death_cross_sell_weight': 20,
        'upwards_trend_macd_sell_weight': 20,
        'upwards_trend_rsi_sell_weight': 20,
        'upwards_trend_sma_long_death_cross_sell_weight': 20,
        'upwards_trend_sma_short_death_cross_sell_weight': 20,
        'upwards_trend_vwap_cross_sell_weight': 20
    }
    ...
    def populate_buy_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        if self.debuggable_weighted_signal_dataframe:
            ...
            dataframe.loc[(dataframe['trend'] == 'downwards') & qtpylib.crossed_above(dataframe['rsi'], 30),
                          'rsi_weighted_buy_signal'] = 1 * self.buy_params['downwards_trend_rsi_buy_weight']
            dataframe.loc[(dataframe['trend'] == 'sideways') & qtpylib.crossed_above(dataframe['rsi'], 30),
                          'rsi_weighted_buy_signal'] = 1 * self.buy_params['sideways_trend_rsi_buy_weight']
            dataframe.loc[(dataframe['trend'] == 'upwards') & qtpylib.crossed_above(dataframe['rsi'], 30),
                          'rsi_weighted_buy_signal'] = 1 * self.buy_params['upwards_trend_rsi_buy_weight']
            ...
            dataframe.loc[(dataframe['trend'] == 'downwards') & (dataframe['macd'] > dataframe['macdsignal']),
                          'macd_weighted_buy_signal'] = 1 * self.buy_params['downwards_trend_macd_buy_weight']
            dataframe.loc[(dataframe['trend'] == 'sideways') & (dataframe['macd'] > dataframe['macdsignal']),
                          'macd_weighted_buy_signal'] = 1 * self.buy_params['sideways_trend_macd_buy_weight']
            dataframe.loc[(dataframe['trend'] == 'upwards') & (dataframe['macd'] > dataframe['macdsignal']),
                          'macd_weighted_buy_signal'] = 1 * self.buy_params['upwards_trend_macd_buy_weight']
    ...
    def populate_sell_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        if self.debuggable_weighted_signal_dataframe:
            ...
            dataframe.loc[(dataframe['trend'] == 'downwards') & qtpylib.crossed_below(dataframe['rsi'], 70),
                          'rsi_weighted_sell_signal'] = 1 * self.sell_params['downwards_trend_rsi_sell_weight']
            dataframe.loc[(dataframe['trend'] == 'sideways') & qtpylib.crossed_below(dataframe['rsi'], 70),
                          'rsi_weighted_sell_signal'] = 1 * self.sell_params['sideways_trend_rsi_sell_weight']
            dataframe.loc[(dataframe['trend'] == 'upwards') & qtpylib.crossed_below(dataframe['rsi'], 70),
                          'rsi_weighted_sell_signal'] = 1 * self.sell_params['upwards_trend_rsi_sell_weight']
            dataframe['total_sell_signal_strength'] += dataframe['rsi_weighted_sell_signal']

            # Weighted Sell Signal: MACD below Signal
            dataframe.loc[(dataframe['trend'] == 'downwards') & (dataframe['macd'] < dataframe['macdsignal']),
                          'macd_weighted_sell_signal'] = 1 * self.sell_params['downwards_trend_macd_sell_weight']
            dataframe.loc[(dataframe['trend'] == 'sideways') & (dataframe['macd'] < dataframe['macdsignal']),
                          'macd_weighted_sell_signal'] = 1 * self.sell_params['sideways_trend_macd_sell_weight']
            dataframe.loc[(dataframe['trend'] == 'upwards') & (dataframe['macd'] < dataframe['macdsignal']),
                          'macd_weighted_sell_signal'] = 1 * self.sell_params['upwards_trend_macd_sell_weight']
