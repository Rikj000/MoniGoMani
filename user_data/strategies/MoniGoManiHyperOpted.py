...
class MoniGoManiHyperOpted(IStrategy):
    ...
    ####################################################################################
    ####                                                                            ####
    ###            MoniGoMani v0.4.1 HyperOpted by Rikj000 (25-03-2021)              ###
    ##             ----------------------------------------------------               ##
    ...
    adx_buy_weight = 22  # triggers moderately
    bollinger_bands_buy_weight = 48  # triggers moderately
    ema_long_golden_cross_buy_weight = 43  # triggers very infrequently
    ema_short_golden_cross_buy_weight = 100  # triggers infrequently
    macd_buy_weight = 43  # triggers frequently
    plus_minus_direction_buy_weight = 17  # triggers very frequently
    rsi_buy_weight = 82  # triggers infrequently
    sma_long_golden_cross_buy_weight = 72  # triggers very infrequently
    sma_short_golden_cross_buy_weight = 75  # triggers infrequently
    vwap_cross_buy_weight = 22  # triggers infrequently
    ...
    adx_sell_weight = 72  # triggers moderately
    bollinger_bands_sell_weight = 46  # triggers moderately
    ema_long_death_cross_sell_weight = 67  # triggers very infrequently
    ema_short_death_cross_sell_weight = 24  # triggers very infrequently
    macd_sell_weight = 81  # triggers frequently
    plus_minus_direction_sell_weight = 49  # triggers very frequently
    rsi_sell_weight = 61  # triggers infrequently
    ...
    vwap_cross_sell_weight = 83  # triggers infrequently
