    ...
    <table>
        <tbody>
            <td align="center">
                ...
                <br>Needs a custom version of Freqtrade for now *([`Rikj000/Freqtrade/hyperopt-show-include-non-optimized-in-json`](https://github.com/Rikj000/Freqtrade/tree/hyperopt-show-include-non-optimized-in-json) at commit `bd44deea`(latest)!)*
